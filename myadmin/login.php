  ...
  <body class="login1">
    ...
    <div class="login-wrapper">
      <div class="login-container">
        <a href="index.php"><img width="200" height="70" src="images/logo-login%402x.png" /></a>
        <form action="login.do.php" method="post" enctype="multipart/form-data" >
          <div class="form-group">
            <input class="form-control" name="username" placeholder="用户名" type="text">
          </div>
          <div class="form-group">
            <input class="form-control" name="userpwd" placeholder="密码" type="password"><input type="submit" value="&#xf054;">
          </div>
        ...
        <p class="signup" style="color:#999">
         Powered by 狗扑分享Gope.Cn wechat wall develop.
        </p>
      </div>
    </div>
    <!-- End Login Screen -->
