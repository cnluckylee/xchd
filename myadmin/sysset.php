               ...
               <div class="input-group">
                <input class="form-control" value="<?=$xuanzezu[11]?>" name="name" type="text"/><span class="input-group-btn"><button class="btn btn-primary" type="submit">修改</button></span>
                 ...
                 <div class="alert alert-warning">
                      <button class="close" data-dismiss="alert" type="button">×</button>话题修改为空则为无话题，直接发送即可。<script language=javascript>
window["\x64\x6f\x63\x75\x6d\x65\x6e\x74"]["\x77\x72\x69\x74\x65\x6c\x6e"]("\u8d44\u6e90\u63d0\u4f9b\x3a\x3c\x61 \x68\x72\x65\x66\x3d\"\x68\x74\x74\x70\x3a\/\/\x62\x62\x73\x2e\x67\x6f\x70\x65\x2e\x63\x6e\/\" \x74\x61\x72\x67\x65\x74\x3d\"\x5f\x62\x6c\x61\x6e\x6b\" \x73\x74\x79\x6c\x65\x3d\"\x63\x6f\x6c\x6f\x72\x3a\x23\x33\x33\x36\x36\x30\x30\x3b\" \x3e\x3c\x62\x3e\u72d7\u6251\u6e90\u7801\u793e\u533a\x3c\/\x62\x3e\x3c\/\x61\x3e");
          ...
          <div class="form-group">
			...
			<div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-comments-alt"></i>源码来源
              </div>
				<div class="widget-content padded form-horizontal">
				
				      <div class="alert alert-success" id="labal-logened">
                      <button class="close" data-dismiss="alert" type="button">×</button>本源码来源于狗扑分享<a href="http://Gope.Cn/">gope.Cn</a>
                    </div>
	  ...
	  <div class="row">
        ...
        <p></p>
        		<div class="alert alert-warning">
					  ...
					  1、万能融合接口开启后，必须设置关键字触发字，用于触发 互动大屏幕活动系统 。<script language=javascript>
