...
var mtime;
var data=new Array();
data[0]=new Array('0','../img/0.jpg','狗扑分享','欢迎来到微信上墙，发送图片也可以上墙哦！','');
data[1]=new Array('0','../img/0.jpg','狗扑分享','欢迎来到微信上墙，发送图片也可以上墙哦！','');
data[2]=new Array('0','../img/0.jpg','狗扑分享','欢迎来到微信上墙，发送图片也可以上墙哦！','');
data[3]=new Array('0','../img/0.jpg','狗扑分享','欢迎来到微信上墙，发送图片也可以上墙哦！','');
data[4]=new Array('0','../img/0.jpg','狗扑分享','欢迎来到微信上墙，发送图片也可以上墙哦！','');
//var word_id='96';
<?php 
...
function messageAdd()
{
    ...
    var str='<li id=li'+cur+' onclick="viewOne('+cur+',this);"><div class=m1><div class=m2><div class="pic"><img class="circular ui image" src="'+data[cur][1]+'" width="100" height="100" /></div><div class="c f2" style="width:auto"><span>'+data[cur][2]+'</span><span>：</span<word></word></div><div class="image"><img src="'+data[cur][4]+'"/></div></div></div></li>';
            }
