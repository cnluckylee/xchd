...
function smallpersonAdd(){
			...
			$('.btnCheckin').attr("id","btnCheckin");
				...
				$('#sign').prepend("<div class='sign-endbutt'><div class='ui huge buttons'><div class='ui green button' id='toshake'>摇一摇</div><div class='or'></div><div class='ui orange button' id='btnCheckin'>互动大屏幕</div></div></div>");
